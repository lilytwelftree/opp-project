...
class Order {
 ...
 public:
  ...
  // access computed cost (set during GenerateRandomOrder)
  ...
  // Core scoring: returns matches [0..4] and satisfaction delta
  // None components incur a heavy penalty (handled here, not UI)
  void Score(const Cake& submitted_cake, int& matches_out, int& satisfaction_delta_out) const;
