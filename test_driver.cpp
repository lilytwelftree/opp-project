 ...
 public:
  ...
  void testSubmitCake() {
    ...
    try {
      ...
      logTest(
          "valid complete cake (chocolate sprinkles, strawberry filling, "
          "vanilla "
          "frosting)",
          test1, test1 ? "" : "cake components not set properly");
    } catch (const std::exception& e) {
      std::cerr << "\nTest 1, test case 1 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 1, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 1, test case 3 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 1, test case 4 failed: " << e.what() << std::endl;
    }
  }
  ...
  void testSetTime() {
    ...
    try {
      ...
      std::cerr << "\nTest 2, test case 1 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 2, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 2, test case 3 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 2, test case 4 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 2, test case 5 failed: " << e.what() << std::endl;
    }
  }
  ...
  void testUpdateLevel() {
    ...
    // test case 1: valid input (revenue: $100, required customer
    // satisfaction: 4)
    try {
      ...
      std::cerr << "\nTest 3, test case 1 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 3, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 3, test case 3 failed: " << e.what() << std::endl;
    }

    // test case 4: valid input (revenue: $0, required customer satisfaction:
    // 0)
    try {
      ...
      std::cerr << "\nTest 3, test case 4 failed: " << e.what() << std::endl;
    }
  }
  ...
  void testApplyDecoration() {
    ...
    // test case 1: valid input (filling class, fillingchoice: "strawberry
    // jam")
    try {
      ...
      std::cerr << "\nTest 4, test case 1 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 4, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr <<"\nTest 4, test case 3 failed: " << e.what() << std::endl;
    }
  }
  ...
  void testSprinkles() {
    ...
    try {
      ...
      std::cerr << "\nTest 5, test case 1 failed: "<< e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 5, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      std::cerr << "\nTest 5, test case 3 failed: " << e.what() << std::endl;
    }
  }
  ...
  void testGiveReview() {
    ...
    try {
      ...
      logTest("perfect accuracy, zero time remaining (4/4 correct, 0s left)",
              test2,
              test2 ? "" : "expected 3-4 stars, got " + to_string(stars2));
    } catch (const std::exception& e) {
      std::cerr << "\nTest 6, test case 2 failed: " << e.what() << std::endl;
    }
    ...
    try {
      ...
      logTest("low accuracy, good time remaining (1/4 correct, 120s left)",
              test3,
              test3 ? "" : "expected 1-3 stars, got " + to_string(stars3));
    } catch (const std::exception& e) {
      std::cerr << "\nTest 6, test case 3 failed: " << e.what() << std::endl;
    }
    ...
    logTest("low accuracy, time penalty (2/4 correct, 30s left)", test4,
        ...
        std::cerr << "\nTest 6, test case 4 failed: " << e.what() << std::endl;
      }
    ...
    logTest(
        ...
        std::cerr << "\nTest 6, test case 5 failed: " << e.what() << std::endl;
      }
    ...
    logTest("division by zero protection (0/0 correct)", test6,
        ...
        std::cerr << "\nTest 6, test case 6 failed: " << e.what() << std::endl;
      }
  }
  ...
  void testEdgeCases() {
    ...
    logTest("customer-time integration", test3,
      ...
      std::cerr << "Exception/Error caught in testEdgeCases: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception caught in testEdgeCases" << std::endl;
    }
  }
  ...
  void runAllTests() {
    ...
    testSubmitCake(); }
      ...
      std::cerr << "Exception/Error during testSubmitCake: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testSubmitCake" << std::endl;
    }

    try{
    testSetTime(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testSetTime: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testSetTime" << std::endl;
    }

    try{
    testUpdateLevel(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testUpdateLevel: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testUpdateLevel" << std::endl;
    }

    try{
    testApplyDecoration(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testApplyDecoration: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testApplyDecoration" << std::endl;
    }

    try{
    testSprinkles(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testSprinkles: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testSprinkles" << std::endl;
    }

    try{
    testGiveReview(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testGiveReview: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testGiveReview" << std::endl;
    }

    try{
    testEdgeCases(); }
    catch (const std::exception& e) {
      std::cerr << "Exception/Error during testEdgeCases: " << e.what() << std::endl;
    }
    catch (...) {
      std::cerr << "Unknown exception during testEdgeCases " << std::endl;
    }
